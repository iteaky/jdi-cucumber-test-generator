...
public class JiraServiceTest {
    ...
    public void createProjectWithAttachments_Project_Success() throws JiraException {
        ...
        jiraService
            .createProjectWithAttachments(JIRA_SETTINGS_ID, Collections.singletonList(jiraStory),
                authentication);
    ...
    public void addStoriesToExistedProject_SuitAndCase_Success() throws Exception {
        ...
        jiraService
            .addStoriesToExistedProject(JIRA_SETTINGS_ID, Collections.singletonList(jiraStory),
                JIRA_PROJECT_KEY);
    ...
    public void getStories_JiraStories_Success() throws JiraException {
        when(jiraStoryDAO.getStories(anyLong(), anyString()))
    ...
    public void getJiraStoriesFromJiraProjectByProjectId_JiraStories_Success() throws JiraException {
        ...
        when(jiraStoryDAO.getNonexistentStoriesByProject(anyLong(), anyString()))
            .thenReturn(Collections.singletonList(jiraStory));

        List<JiraStory> stories = jiraService
            .getJiraStoriesFromJiraProjectByProjectId(JIRA_SETTINGS_ID, JIRA_PROJECT_KEY);
        Assert.assertTrue(!stories.isEmpty());
    }

    @Test
    public void getNonexistedJiraProjects_JiraProjects_Success() throws JiraException {
        when(jiraProjectDAO.getAllProjects(anyLong()))
            .thenReturn(Collections.singletonList(jiraProject));
    ...
    public void syncFromJiraUpdateSuitAndCase_SuitAndCase_Success() throws JiraException {
        ...
        when(jiraSubStoryDAO.getJiraSubtoriesByFilter(anyLong(), anyString()))
            .thenReturn(Arrays.asList(jiraSubTask));
