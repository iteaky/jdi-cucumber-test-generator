...
public class JiraControllerTest {
    ...
    public void createStoriesForProject() throws Exception {
        ...
        mockMvc.perform(
            post("/jira/ " + JIRA_SETTINGS_ID + "/project/" + SIMPLE_JIRA_PROJECT_KEY + "/suits")
        ...
        verify(jiraService)
            .addStoriesToExistedProject(JIRA_SETTINGS_ID, jiraStories, SIMPLE_JIRA_PROJECT_KEY);
    }
    ...
    public void createProjectWithAttFromJira() throws Exception {
        ...
        verify(jiraService).createProjectWithAttachments(eq(JIRA_SETTINGS_ID), any(List.class),
